...
joint_name_map = {"first_joint":1, "second_joint":2, "third_joint":3, "fourth_joint": 4, "fifth_joint":5, "sixth_joint":6, "seventh_joint":7}
...
def sendCommand(data):
    ...
    command_json = {"command": "--ts", "joint_id": "all"}
    socket.send(json.dumps(command_json))
    res = socket.recv()
