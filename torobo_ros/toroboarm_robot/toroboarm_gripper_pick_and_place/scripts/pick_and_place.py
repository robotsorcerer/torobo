...
class CokeCanPickAndPlace:
    def __init__(self):
        ...
        self._pose_place.position.y = self._pose_coke_can.position.y - 0.1
    ...
    def _add_coke_can(self, name):
        ...
        p.pose.position.x = 0.55 - 0.01
        p.pose.position.y = 0.25 - 0.01
        p.pose.position.z = 0.60 + (0.3 + 0.03) / 2.0
        ...
        self._scene.add_box(name, p, (0.05, 0.05, 0.15))
